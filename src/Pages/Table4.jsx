...
{DeleteModal && (
      ...
      <p className='p-2 font-bold font-[Century Gothic]'>Admin</p>
        ...
        <table className='min-w-full divide-y divide-black border-black border'>
          <thead className='bg-gray-50'>
            <tr>
              ...
              <th className="border border-gray-500 px-1 py-1 text-center text-sm text-black tracking-wider bg-[#E7E7E7]">User ID</th>
              <th className="border border-gray-500 px-1 py-1 text-center text-sm text-black tracking-wider bg-[#E7E7E7]">User Name</th>
          ...
          <tbody className='bg-white divide-y divide-black'>
            {rows.map((row, index) => (
              <tr key={row.serial}>
                ...
                <td className="border text-center border-gray-200 px-6 py-3 text-sm text-[#A0A0A0]">{row.username}</td>
